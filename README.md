...
Buka file `bfs.py dan dffs.py` di menggunakan Visual Studio Code atau software lain yang mendukung penampilan hasil code. Lalu upload semua file dan folder yang ada di dalam repository untuk melihat semua aset yang ada di Website tersebut.
